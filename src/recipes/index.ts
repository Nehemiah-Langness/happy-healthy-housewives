...
import brisChickenTendies from './bris-chicken-tendies';
...
import chocolatePeppermintChipCookies from './chocolate-peppermint-chip-cookies';
...
import mamasShepardsPie from './mamas-shepards-pie';
...
import noWaitSourdoughPizza from './no-wait-sourdough-pizza';
...
import pretzelMess from './pretzel-mess';
...
import skilletLasagna from './skillet-lasagna';
import smashedPotatos from './smashed-potatos';
import smokedChickenThighs from './smoked-chicken-thighs';
import softSugarCookieBars from './soft-sugar-cookie-bars';
import spicyCreamyPenne from './spicy-creamy-penne';
import superfoodChili from './superfood-chili';
...
import walnutSnowballs from './walnut-snowballs';
...
export const recipes = {
    ...
    ['bris-chicken-tendies']: brisChickenTendies,
    ...
    ['chocolate-peppermint-chip-cookies']: chocolatePeppermintChipCookies,
    ...
    ['mamas-shepards-pie']: mamasShepardsPie,
    ...
    ['no-wait-sourdough-pizza']: noWaitSourdoughPizza,
    ...
    ['skillet-lasagna']: skilletLasagna,
    ['smashed-potatos']: smashedPotatos,
    ['smoked-chicken-thighs']: smokedChickenThighs,
    ['soft-sugar-cookie-bars']: softSugarCookieBars,
    ['spicy-creamy-penne']: spicyCreamyPenne,
    ['superfood-chili']: superfoodChili,
    ...
    ['walnut-snowballs']: walnutSnowballs,
