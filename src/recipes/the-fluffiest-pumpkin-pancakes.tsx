...
const recipe: Recipe = {
    ...
    ingredients: [
        ['Flour', 'Whole Grain Flour', 'Whole Wheat Flour', 'Einkorn Flour', 'Sprouted Flour', 'Oat Flour'],
        ['Plain Low-fat Kefir', 'Dairy Free Yogurt'],
    ...
    Notes: (
        <>
            <p>
                <b>THM Compliance:</b> This recipe is <AffiliateLink>THM</AffiliateLink> compliant because it soaks the flour in a acidic
                medium overnight, much like using a sourdough starter. If you don't wish to soak this recipe, you can use a sprouted grain
                flour or oat flour.
            </p>
        </>
    ),
