...
const recipe: Recipe = {
    ...
    Directions: (
        <>
            <p>
                Take your Crock-Pot and place it on top of a large towel, place lid on top and turn on low.
                <Footnote count={2} />
            </p>
            ...
            <p>
                Wrap the jars in cloth and place inside Crock-Pot.
                <Footnote count={2} />
            </p>
            <p>
                Turn off and unplug the Crock-Pot, wrap it all in the large towel.
                <Footnote count={2} />
            </p>
    ...
    Notes: (
        <>
            ...
            <p>
                <Footnote /> If you don't have baobab or “gluccie” on hand, you replace both with 5 tsp of xanthem gum.
            </p>
            <p>
                <Footnote count={2} /> if you have an Instapot, just place jars in there and hit the yogurt setting, set for 24 hours.
            </p>
        </>
    ),
};
